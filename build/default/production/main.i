...
# 52 "C:/Program Files (x86)/Microchip/MPLABX/v5.40/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8\pic\include\proc\pic18f45k50.h"
...
d_EchoPeriod = giEchoCounter.EP16 * 500.0e-9;
d_CurrTemp = 20.0;
d_SOS = 331.3e3 * sqrt( 1 + (d_CurrTemp / 273.15));
d_mmPerTick = d_SOS * 500.0e-9 / 2;
...
sprintf(sGals, "%n4", d_WaterVol);
LCD_GoTo (0, 5);
LCD_WriteString (sGals);
sprintf (sFill, "%n3", i_PercentFull);
LCD_GoTo (0, 10);
...
sprintf(gsTotalSecs, "%n3");
LCD_GoTo (1, 12);
LCD_WriteString (gsTotalSecs);
sprintf(gsCurrTime, "%n2/%n2/%n2", giHours, giMins, giSecs);
